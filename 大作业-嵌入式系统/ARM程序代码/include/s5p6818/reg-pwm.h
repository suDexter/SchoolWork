...
#define S5P6818_PWM_TCNTB	  	(S5P6818_PWM_BASE + 0x0044)

#define S5P6818_PWM_TCMPB0	  	(S5P6818_PWM_BASE + 0x0010)
#define S5P6818_PWM_TCNTB0	  	(S5P6818_PWM_BASE + 0x000c)
